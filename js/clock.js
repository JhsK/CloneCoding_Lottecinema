...
function loadClock() {
    ...
    clockText.innerText = `${(clockMonth) < 10 ? `0${clockMonth}` : clockMonth}.${clockDay < 10 ? `0${clockDay}` : clockDay} ${clockHours < 10 ? `0${clockHours}` : clockHours}:${clockMinutes < 10 ? `0${clockMinutes}` : clockMinutes} 기준`;
}
